<?php get_header(); ?>
        ...
        <div class="toys" id="toys">
            <div class="container">
                ...
                <div class="toys__wrapper">
                    ...
                    <div class="toys__item" style="background-image: 
                        url(<?php 
                                if(has_post_thumbnail()) {
                                    the_post_thumbnail_url(); 
                                }else{
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                <h1 class="title"><?php the_field('title_story'); ?></h1>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('subtitle_story_1'); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('description_story_1'); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img src="<?php the_field('img_story_1'); ?>" alt="история компанию">
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-6">
                        <img src="<?php the_field('img_story_2'); ?>" alt="история компанию">
                    </div>
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('subtitle_story_2'); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('description_story_2'); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('subtitle_story_3'); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('description_story_3'); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img src="<?php the_field('img_story_3'); ?>" alt="история компанию">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="contacts__feed">
                            <?php
                            echo do_shortcode('[contact-form-7 id="167" title="Форма отзывов"]');
                       ?>
                        </div>
